...
<body>
	...
	<div style="display: flex; margin-top: 50px;">
		...
		<div
			...
			<h1 style="text-align: center;">ADD&UPDATE SLIDES</h1>
			<%
			...
			<table border='1' id="profile-details">
				...
				<tr style="text-align: center;">
					...
					<td><button id="edit-profile-button" type="button"
							...
							style="background: none; border-color: purple;">EDIT</button></td>
				</tr>
			...
			<form action="UpdateSlides" method="post"
				...
				<table border='1' id="profile-edit" style="display: none;">
					...
					<tr style="text-align: center;">
						...
						<td>Slide1</td>
						<td><input type="file" name="slide1"
							value="<% eb.getSlide1(); %>"></td>
						<td><button id="edit-profile-button" type="button"
								class="btn btn-primary"
								style="background: none; border-color: purple;">EDIT</button></td>
					</tr>
					...
					<tr style="text-align: center;">
						<td>Slide2</td>
						<td><input type="file" name="slide2"
							value="<% eb.getSlide2(); %>"></td>
						<td><button id="edit-profile-button" type="button"
								class="btn btn-primary"
								style="background: none; border-color: purple;">EDIT</button></td>
					...
					<tr style="text-align: center;">
						<td>Slide3</td>
						<td><input type="file" name="slide3"
							value="<% eb.getSlide3(); %>"></td>
						<td><button id="edit-profile-button" type="button"
								class="btn btn-primary"
								style="background: none; border-color: purple;">EDIT</button></td>
					</tr>
				...
				<button id="edit-profile-button" type="submit"
					class="btn btn-primary"
					style="background: none; border-color: purple;">SAVE</button>
			</form>
