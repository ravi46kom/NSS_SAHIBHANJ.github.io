...
<title>ADMIN PANEL~NOTICE</title>
<!-- css -->
<style type="text/css">
.primary-background {
	background: #cc0000;
	...
	<div style="display: flex; margin-top: 50px;">
		<div class="slidenav" style="left: 0;">
			...
			<label style="display: block; text-align: center;">Dr. Ranjit
				...
				href="#">Add/Update Notice</a> <a href="addOrUpdateEvents.jsp">Add/Update
				Events</a> <a href="#">Add Award&Awardees</a> <a href="#">Update/Add
				Regular Activities</a><a href="user-list.jsp">Student List Month
				Wise</a> <a href="#">List Year Wise</a> <a href="sstudentlist.jsp">All
				Student List</a>

		</div>
		<div
			style="background: #000; width: 81.5%; color: red; height: 100%; position: absolute; right: 0;">
			<a type="button" class="btn btn-primary" data-toggle="modal" data-target="#staticBackdrop">Add Notices</a>
			<h1 style="text-align: center;">Notice List</h1>
			<%
				NoticeEventImageDao dao = new NoticeEventImageDao();
					List<Noticebean> list = dao.getAllNotices();
			...
			<table border='1' id="profile-details">
				...
				<tr>
					...
					<td><a
						href="deletenotice.jsp?notices=
					
					<%=user.getNotices()%>" >Delete</a></td>
				</tr>
				<%
					}
				%>
			...
			<form action="#">
				<table border='1' id="profile-edit" style="display: none;">
					...
					<tr>
						...
						<td><input name="notice" type="text"
							value="<%=user.getNotices()%>"></td>
...
<div class="modal fade" id="staticBackdrop" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content" style="background: #000; width:100%; color: red; height: 100%; position: absolute; right: 0;">
